...
public class ProductDAO implements Constant {
    ...
    public long insertProduct(Product product) {
        ...
        contentValues.put(PRODUCT_PHOTO,product.getImgProduct());
        contentValues.put(OLD_PRODUCT_PHOTO,product.getOldImgProduct());
    ...
    public List<Product> getAllProduct() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                byte[] oldImgProduct = cursor.getBlob(cursor.getColumnIndex(OLD_PRODUCT_PHOTO));
                ...
                product.setOldImgProduct(oldImgProduct);
    ...
    public Product getProductByID(String ID) {
        ...
        Cursor cursor = db.query(PRODUCT_TABLE, new String[]{PRODUCT_ID, PRODUCT_NAME, PRODUCT_TYPEID, INPUT_PRICE, OUTPUT_PRICE, QUANTITY, PRODUCT_DES, OLD_PRODUCT_NAME, OLD_PRODUCT_TYPEID, OLD_INPUT_PRICE, OLD_OUTPUT_PRICE, OLD_QUANTITY, OLD_PRODUCT_DES, ADDED_DAY, EDITED_DAY,PRODUCT_PHOTO,OLD_PRODUCT_PHOTO},
