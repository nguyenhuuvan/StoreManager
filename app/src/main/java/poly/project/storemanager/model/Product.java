...
public class Product {
    ...
    private byte[]imgProduct,oldImgProduct;
    ...
    public byte[] getOldImgProduct() {
        return oldImgProduct;
    }

    public void setOldImgProduct(byte[] oldImgProduct) {
        this.oldImgProduct = oldImgProduct;
    }
